...
const Weight_Training = ({ props, navigation }) => {
  const [weight, setWeight] = useState([])
  const workoutRef = firebase.firestore().collection('workout').doc('XXVlurGq69GuDCTFmCU2').collection('exercise').doc('Weight Training').collection('Weight_Training_posture');
