...
class  Aerobic extends Component   {
 

  constructor() {
    
    super();
    this.firestoreRef = firebase.firestore().collection('workout').doc('XXVlurGq69GuDCTFmCU2').collection('exercise').doc('Aerobic').collection('Aerobic_posture');
    this.state = {
      isLoading: true,
      userArr: []
    };
